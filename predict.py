...
parser.add_argument('--save_dir', action='store',
                    dest='save_directory', default = 'project2.pth',
                    help='Enter location to save checkpoint in.')

parser.add_argument('--arch', action='store',
                    dest='pretrained_model', default='densenet121',
                    help='Enter pretrained model to use, default is  denseSet121.')
...
for i in classes:
    names += [cat_to_name[i]]
print(f"This flower is : '{names[0]}' with a prob of {round(probs[0]*100,4)}% ")
